...
const orderRows = [
    { id: "001", customer: "andi", item: "Ayam", total: "Rp.78.000", status: "Preparing" },
    { id: "002", customer: "agus", item: "Kebab", total: "Rp.92.000", status: "On Delivery" },
    { id: "003", customer: "fend", item: "Burger", total: "Rp.105.000", status: "Delivered" },
    { id: "004", customer: "stifend", item: "Coffe", total: "Rp.64.000", status: "Canceled" },
    { id: "005", customer: "anto", item: "Pizza", total: "Rp.88.000", status: "Preparing" },
];

const customerRows = [
    { id: "001", name: "andi", email: "andi@email.com", totalOrder: 14, city: "Bandung", tier: "Gold" },
    { id: "002", name: "agus", email: "agus@email.com", totalOrder: 9, city: "Jakarta", tier: "Silver" },
    { id: "003", name: "fend", email: "fend@email.com", totalOrder: 21, city: "Surabaya", tier: "Platinum" },
    { id: "004", name: "stifend", email: "stifend@email.com", totalOrder: 5, city: "Malang", tier: "Bronze" },
    { id: "005", name: "anto", email: "anto@email.com", totalOrder: 12, city: "Semarang", tier: "Gold" },
];
